...
function install_apps_from_repos() {
    ...
    sudo zypper -n remove gnome-terminal eog cheese evolution vinagre xterm file-roller git-gui lightsoff gnome-mines iagno quadrapassel swell-foop gnome-sudoku
