...
function install_apps() {
    ...
    sleep 1
    sudo zypper install --type pattern devel_basis devel_C_C++ kvm_server kvm_tools devel_qt6
...
function install_cpp_libraries() {
    ...
    if [ "$BUILD" == "y" ]; then
        ...
        echo "Libnick..."
        cd ~
        git clone --depth 1 --branch "2024.8.2" https://github.com/NickvisionApps/libnick/
