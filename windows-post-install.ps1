...
if ($vcpkg -eq 'y') {
    ...
    .\vcpkg.exe install boost-date-time boost-json curl gettext-libintl gflw3 gtest libnick maddy skia[core,fontconfig,freetype,gl,harfbuzz,icu,vulkan] sqlcipher qtbase qtsvg qttools
}
